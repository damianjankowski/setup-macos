...
export -f install_homebrew update_homebrew get_homebrew_status show_homebrew_menu handle_homebrew_menu install_brew_packages cleanup_homebrew zap_uninstall_packages
