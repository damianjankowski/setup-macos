...
export -f add_kitty_config add_warp_config add_yazi_config add_delta_config add_aerospace_config apply_kitty_config apply_warp_config apply_yazi_config apply_delta_config apply_aerospace_config apply_chezmoi_config show_chezmoi_menu handle_chezmoi_menu chezmoi_tools